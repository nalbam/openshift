...
function add_nexus3_repos() {
  ...
  add_nexus3_group_repo maven-central,maven-releases,maven-snapshots,jboss-ce,redhat-ga,redhat-ea,redhat-tp,jcenter,jitpack maven-all-public ${_NEXUS_USER} ${_NEXUS_PWD} ${_NEXUS_URL}
}
