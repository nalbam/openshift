...
function add_nexus2_redhat_repos() {
  ...
  add_nexus2_repo redhat-tp https://maven.repository.redhat.com/techpreview/all/ ${_NEXUS_USER} ${_NEXUS_PWD} ${_NEXUS_URL}
  ...
  add_nexus2_group_repo redhat-tp public ${_NEXUS_USER} ${_NEXUS_PWD} ${_NEXUS_URL}
